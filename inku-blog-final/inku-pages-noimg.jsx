    ...
    <main style={{ background: INKU.surface }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '40px 32px 0' }}>
        ...
        <section style={{
          ...
          <div style={{ width: 180, height: 180, borderRadius: 20, background: INKU.magenta, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <span style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 800, fontSize: 64, color: '#fff', letterSpacing: '0.04em' }}>I</span>
          </div>
          <div>
            <Kicker color={INKU.magenta} style={{ display: 'block', marginBottom: 10 }}>Nouveau service</Kicker>
            <h3 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 30, color: INKU.deep, margin: '0 0 10px', letterSpacing: '-0.01em' }}>
              L'anime te laisse sur ta faim ? On te dit où reprendre en manga.
            </h3>
            <p style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 15, lineHeight: 1.5, color: INKU.neutral, margin: 0, maxWidth: 520 }}>
    ...
    <main style={{ background: '#fff' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '40px 32px 0' }}>
        <header style={{ marginBottom: 40, paddingBottom: 32, borderBottom: `1px solid ${INKU.border}` }}>
          ...
          <h1 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 56, color: INKU.deep, margin: '0 0 16px', letterSpacing: '-0.02em' }}>
            News
          </h1>
          <p style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 17, lineHeight: 1.5, color: INKU.neutral, margin: '0 0 24px', maxWidth: 640 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: 64, alignItems: 'start' }}>
          ...
          <aside style={{ position: 'sticky', top: 96, display: 'flex', flexDirection: 'column', gap: 24 }}>
              ...
              <ol style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 18 }}>
                {TRENDING.concat([LATEST[0]]).slice(0, 5).map((a, i) => (
                  <li key={i} style={{ display: 'grid', gridTemplateColumns: '32px 1fr', gap: 12, cursor: 'pointer' }} onClick={() => onArticle(a)}>
                    <span style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 28, color: INKU.magenta, lineHeight: 1 }}>0{i+1}</span>
                    <div>
                      <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 14, color: INKU.ink, lineHeight: 1.25 }}>{a.title}</div>
                      <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 11, color: INKU.neutral, marginTop: 4 }}>{a.category} · {a.readMin} min</div>
                    </div>
                  </li>
                ))}
              </ol>
            ...
            <div style={{
              ...
              <h3 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 22, color: '#fff', margin: '0 0 8px', lineHeight: 1.15 }}>
                Le récap du dimanche
              </h3>
              <p style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 13, lineHeight: 1.45, color: 'rgba(255,255,255,0.85)', margin: '0 0 14px' }}>
    ...
    <main style={{ background: INKU.surface }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '40px 32px 0' }}>
        <header style={{ marginBottom: 32 }}>
          ...
          <p style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 17, lineHeight: 1.5, color: INKU.neutral, margin: '0 0 0', maxWidth: 640 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <strong style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 15, color: INKU.ink }}>Sem. du 27 avr. → 3 mai</strong>
        ...
        {/* legend */}
        <div style={{ display: 'flex', gap: 22, flexWrap: 'wrap', marginBottom: 80, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 13, color: INKU.ink }}>
          ...
          {SEASON_HIGHLIGHTS.map((h, i) => (
            <article key={i} style={{
              ...
              <div style={{ padding: 16 }}>
                ...
                <h4 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 18, color: INKU.ink, margin: '8px 0 8px', lineHeight: 1.2 }}>{h.title}</h4>
                <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 12, color: INKU.neutral }}>{h.studio} · {h.day}</div>
              </div>
            </article>
          ))}
        </div>
    ...
    <main style={{ background: '#fff' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '40px 32px 0' }}>
        <header style={{ marginBottom: 40 }}>
          ...
          <p style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 17, lineHeight: 1.5, color: INKU.neutral, margin: '0 0 32px', maxWidth: 640 }}>
          ...
          <div style={{
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input value={search} onChange={(e)=>setSearch(e.target.value)} placeholder="cherche un anime — ex. Jujutsu Kaisen, Demon Slayer…" style={{
                ...
                fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 16, background: '#fff',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20, marginBottom: 80 }}>
          ...
          {filtered.length === 0 && (
            <div style={{ padding: '60px 0', textAlign: 'center', color: INKU.neutral, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif" }}>
        ...
        <section style={{
          ...
          <div>
            <h3 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 24, color: INKU.deep, margin: '0 0 6px' }}>
              Manque un titre dans la liste ?
            </h3>
            <p style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 15, color: INKU.neutral, margin: 0 }}>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '40px 32px 0' }}>
        ...
        <section style={{
          ...
          <div>
            ...
            <h1 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 64, color: INKU.deep, margin: '0 0 24px', letterSpacing: '-0.025em', lineHeight: 1 }}>
              On écrit sur l'anime<br />comme on en parle entre fans.
            </h1>
            <p style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 18, lineHeight: 1.6, color: INKU.ink, margin: '0 0 18px' }}>
            ...
            <p style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 16, lineHeight: 1.6, color: INKU.neutral, margin: '0 0 32px' }}>
          ...
          <div style={{
            ...
            <div style={{ width: 240, height: 280, borderRadius: 16, background: INKU.deep, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <span style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 800, fontSize: 110, color: INKU.rose, letterSpacing: '0.04em', lineHeight: 1 }}>I</span>
            </div>
            <div style={{ marginTop: 16 }}>
              <h3 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 20, color: INKU.deep, margin: '0 0 4px' }}>Inku, la pieuvre</h3>
              <p style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 13, color: INKU.neutral, margin: 0 }}>Notre rédactrice en chef officieuse, et le visage du site.</p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          {[
            ...
            <div key={i} style={{ borderLeft: i === 0 ? 'none' : '1px solid rgba(255,255,255,0.15)', padding: '0 32px' }}>
              <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 56, color: INKU.rose, lineHeight: 1, margin: '0 0 12px', letterSpacing: '-0.02em' }}>{s.num}</div>
              <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 18, color: '#fff', margin: '0 0 4px' }}>{s.label}</div>
              <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 13, color: 'rgba(255,255,255,0.7)' }}>{s.sub}</div>
            </div>
          ))}
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
            {[
              ...
              <div key={i} style={{ background: '#fff', border: `0.5px solid ${INKU.border}`, borderRadius: 16, padding: 32 }}>
                ...
                <h3 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 22, color: INKU.deep, margin: '0 0 10px' }}>{v.title}</h3>
                <p style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 15, lineHeight: 1.55, color: INKU.neutral, margin: 0 }}>{v.text}</p>
              </div>
            ))}
          </div>
        </section>
              ...
              return (
                <article key={i} style={{ background: '#fff', border: `0.5px solid ${INKU.border}`, borderRadius: 14, padding: 24, textAlign: 'center' }}>
                  <div style={{
                    ...
                    background: pickTint(m.name),
                    margin: '0 auto 16px',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    color: '#fff', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 28,
                  }}>{initials}</div>
                  <h3 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontWeight: 700, fontSize: 18, color: INKU.ink, margin: '0 0 4px' }}>{m.name}</h3>
                  <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 13, color: INKU.magenta, fontWeight: 600, marginBottom: 10 }}>{m.role}</div>
                  <p style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif", fontSize: 13, lineHeight: 1.45, color: INKU.neutral, margin: 0 }}>{m.bio}</p>
                </article>
              );
            })}
          </div>

  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: 'linear-gradient(180deg, transparent 30%, rgba(26,26,46,0.45) 65%, rgba(26,26,46,0.92) 100%)',
      }} />
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 16, alignItems: 'center' }}>
          ...
          <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.7)', fontFamily: "'Outfit',sans-serif" }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{
            ...
            background: `linear-gradient(135deg, ${INKU.magenta}, ${INKU.violet})`,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontFamily: "'Space Grotesk',sans-serif", fontWeight: 700, color: '#fff', fontSize: 13,
          }}>{(article.author || 'IK').split(' ').map(w => w[0]).slice(0,2).join('')}</div>
          <div>
            <div style={{ fontFamily: "'Outfit',sans-serif", fontSize: 14, fontWeight: 600, color: '#fff' }}>{article.author || "L'équipe INKU"}</div>
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.6)', fontFamily: "'Outfit',sans-serif" }}>{article.authorRole || 'Rédaction'}</div>
          </div>
        </div>
      </div>
    </article>
    ...
    >
      ...
      <div style={{ padding: '18px 20px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        <div>
          ...
          <p style={{ fontFamily: "'Outfit',sans-serif", fontSize: 13, lineHeight: 1.5, color: INKU.neutral, margin: 0,
            display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
            {article.excerpt}
          </p>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 14, color: INKU.neutral, fontSize: 11, fontFamily: "'Outfit',sans-serif" }}>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: 18, display: 'flex', flexDirection: 'column', gap: 10, flex: 1 }}>
        ...
        {article.excerpt && (
          <p style={{
            fontFamily: "'Outfit',sans-serif", fontSize: 13, lineHeight: 1.5,
            color: INKU.neutral, margin: 0,
            display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden',
          }}>{article.excerpt}</p>
        )}
        <div style={{ marginTop: 'auto', display: 'flex', alignItems: 'center', gap: 8, color: INKU.neutral, fontSize: 11, fontFamily: "'Outfit',sans-serif" }}>
          <Icon name="clock" size={12} color={INKU.neutral} />
          {article.time}
          <span>·</span>
          {article.readMin} min
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
          <Kicker>{article.category}</Kicker>
          <span style={{ color: INKU.neutral, fontSize: 12, fontFamily: "'Outfit',sans-serif" }}>·</span>
          <span style={{ color: INKU.neutral, fontSize: 12, fontFamily: "'Outfit',sans-serif" }}>{article.time}</span>
          <span style={{ color: INKU.neutral, fontSize: 12, fontFamily: "'Outfit',sans-serif" }}>·</span>
          <span style={{ color: INKU.neutral, fontSize: 12, fontFamily: "'Outfit',sans-serif" }}>{article.readMin} min</span>
        </div>
        <h3 style={{
          fontFamily: "'Space Grotesk',sans-serif", fontWeight: 700,
        ...
        <p style={{ fontFamily: "'Outfit',sans-serif", fontSize: 15, lineHeight: 1.5, color: INKU.neutral, margin: 0,
          display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
          {article.excerpt}
        </p>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 12 }}>
          <div style={{
            ...
            background: `linear-gradient(135deg, ${INKU.magenta}, ${INKU.violet})`,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontFamily: "'Space Grotesk',sans-serif", fontWeight: 700, color: '#fff', fontSize: 10,
          }}>{(article.author || 'IK').split(' ').map(w => w[0]).slice(0,2).join('')}</div>
          <span style={{ fontFamily: "'Outfit',sans-serif", fontSize: 12, color: INKU.ink, fontWeight: 600 }}>{article.author || "L'équipe INKU"}</span>
        </div>
      </div>
    </article>
  );
    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '88px 1fr', gap: 16, alignItems: 'center' }}>
        ...
        <div>
          ...
          <h3 style={{ fontFamily: "'Space Grotesk',sans-serif", fontWeight: 700, fontSize: 20, color: INKU.ink, margin: '0 0 6px', lineHeight: 1.15 }}>
            {row.anime.title}
          </h3>
          <div style={{ fontFamily: "'Outfit',sans-serif", fontSize: 13, color: INKU.neutral, marginBottom: 8 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '88px 1fr', gap: 16, alignItems: 'center' }}>
        ...
        <div>
          ...
          <h3 style={{ fontFamily: "'Space Grotesk',sans-serif", fontWeight: 700, fontSize: 20, color: INKU.deep, margin: '0 0 6px', lineHeight: 1.15 }}>
